...
static constexpr char system_prompt[] =
    ...
    "plot_line with 2 to 24 matching literal x and y points and a short "
...
inline const char *routing_prompt() {
    static const std::array<char, 2'048> prompt = [] {
        ...
        const int size = std::snprintf(
            ...
            "result ID. Use run_python only for numeric calculations. Python "
            "must print each value needed for the answer. When the user asks "
            "for a plot, call plot_line with a plot object that has 2 to 24 "
            ...
            "Python code for a plot. One plot_line call completes routing. Use "
